...
public class ListRekamMedisPriaActivity extends AppCompatActivity{
    ...
    public ListRekamMedisPriaActivity(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_rekammedis.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int urutan, long id) {
                ...
                Intent i = null;
                i = new Intent(ListRekamMedisPriaActivity.this, DetailRekamMedisActivity.class);
                Bundle b = new Bundle();
    ...
    class ReadRekamMedisTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ListRekamMedisPriaActivity.this);
        ...
        protected String doInBackground(String... sText) {
            url_tampil_medis= "http://rekammedis.gudangtechno.web.id/android/tampil_medis.php?no_ktp="+ListRekamMedisPriaActivity.this.strktp;
            RekamMedis tempMedis = new RekamMedis();
            try {
                JSONObject json = ListRekamMedisPriaActivity.this.jsonParser.getJSONFromUrl(url_tampil_medis);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(ListRekamMedisPriaActivity.this, "Periksa Koneksi Internet Anda...", Toast.LENGTH_LONG).show();
            }
            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(ListRekamMedisPriaActivity.this, "Data Rekam Medis Masih Kosong", Toast.LENGTH_LONG).show();
            }
            if(success == 1) {
                list_rekammedis.setAdapter(new RekamMedisAdapter(ListRekamMedisPriaActivity.this, ListRekamMedisPriaActivity.this.daftar_rekammedis));
            }
        }
    }
    @Override
    ...
    public void onBackPressed() {
        Intent intent = new Intent(this, MainPriaActivity.class);
