...
public class UpdateFotoPerempuanActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_foto_perempuan);
    ...
    private void uploadImage(){
        class UploadImage extends AsyncTask<Bitmap,Void,String>{
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                loading = ProgressDialog.show(UpdateFotoPerempuanActivity.this, "Uploading...", null,true,true);
            }
