...
public class PetugasUpdateRekamMedisOrtuActivity extends AppCompatActivity {
    ...
    class update_rekam implements View.OnClickListener {
        public void onClick(View v) {
            PetugasUpdateRekamMedisOrtuActivity.this.validation();
        }
    }
    ...
    public void setDateTimeField() {
        this.tanggal_pemeriksaan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                PetugasUpdateRekamMedisOrtuActivity.this.tanggal_dialog.show();
            }
        });
        ...
        this.tanggal_dialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                PetugasUpdateRekamMedisOrtuActivity.this.tanggal_pemeriksaan.setText(PetugasUpdateRekamMedisOrtuActivity.this.dateFormatter.format(newDate.getTime()));
            }
    ...
    public class updateMedisOrtu extends AsyncTask<String, String, String> {
        ...
        public updateMedisOrtu() {
            this.strtanggal = PetugasUpdateRekamMedisOrtuActivity.this.tanggal_pemeriksaan.getText().toString();
            this.strkeluhan = PetugasUpdateRekamMedisOrtuActivity.this.keluhan.getText().toString();
            this.strriwayat = PetugasUpdateRekamMedisOrtuActivity.this.riwayat_penyakit.getText().toString();
            this.strdiagnosa = PetugasUpdateRekamMedisOrtuActivity.this.diagnosa.getText().toString();
            this.strmedis = PetugasUpdateRekamMedisOrtuActivity.this.tindakan_medis.getText().toString();
            this.strobat = PetugasUpdateRekamMedisOrtuActivity.this.obat.getText().toString();
        }

        protected void onPreExecute() {
            super.onPreExecute();
            PetugasUpdateRekamMedisOrtuActivity.this.pDialog = new ProgressDialog(PetugasUpdateRekamMedisOrtuActivity.this);
            PetugasUpdateRekamMedisOrtuActivity.this.pDialog.setMessage("Loading...");
            PetugasUpdateRekamMedisOrtuActivity.this.pDialog.setIndeterminate(false);
            PetugasUpdateRekamMedisOrtuActivity.this.pDialog.show();
        }
        ...
        public String getPertumbuhanList() {
            ...
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_ID_REKAM, stridrekam));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_TANGGAL, this.strtanggal));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_KELUHAN, this.strkeluhan));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_RIWAYAT, this.strriwayat));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_DIAGNOSA, this.strdiagnosa));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_TINDAKAN, this.strmedis));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_OBAT, this.strobat));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_KTP, strktp));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisOrtuActivity.TAG_PETUGAS, strpetugas));
        ...
        protected void onPostExecute(String result) {
            ...
            PetugasUpdateRekamMedisOrtuActivity.this.pDialog.dismiss();

            if (result.equalsIgnoreCase("Error Converting")){
                Toast.makeText(PetugasUpdateRekamMedisOrtuActivity.this, "Periksa Koneksi Internet Anda...",  Toast.LENGTH_SHORT).show();
            }
            else if (result.equalsIgnoreCase("Exception Caught")){
                Toast.makeText(PetugasUpdateRekamMedisOrtuActivity.this, "Periksa Koneksi Internet Anda...",  Toast.LENGTH_SHORT).show();
            }
            else if (success == 1){
                AlertDialog.Builder pDialog = new AlertDialog.Builder(PetugasUpdateRekamMedisOrtuActivity.this);
                ...
                Toast.makeText(PetugasUpdateRekamMedisOrtuActivity.this.getApplicationContext(), "Gagal Update Data Rekam Medis...", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected class berhasil implements DialogInterface.OnClickListener {
            public void onClick(DialogInterface dialog, int d) {
                dialog.dismiss();
                Intent medis = new Intent(PetugasUpdateRekamMedisOrtuActivity.this, PetugasMenuPerempuanActivity.class);
                startActivity(medis);
                PetugasUpdateRekamMedisOrtuActivity.this.finish();
            }
        }
    }
