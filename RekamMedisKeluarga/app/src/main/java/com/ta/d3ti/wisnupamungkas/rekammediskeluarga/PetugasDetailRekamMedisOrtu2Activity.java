...
public class PetugasDetailRekamMedisOrtu2Activity extends AppCompatActivity {
    ...
    protected String isi_periksa,isi_ktp,isi_petugas;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_petugas_detail_rekam_medis_ortu);
    ...
    class edit_medis implements View.OnClickListener{
        public void onClick(View v) {
            ...
            Intent i = new Intent(PetugasDetailRekamMedisOrtu2Activity.this, PetugasUpdateRekamMedisOrtu2Activity.class);
            Bundle b = new Bundle();
    ...
    class hapus_medis implements View.OnClickListener{
        public void onClick(View v){
            AlertDialog.Builder builder = new AlertDialog.Builder(PetugasDetailRekamMedisOrtu2Activity.this);
    ...
    public PetugasDetailRekamMedisOrtu2Activity() {
        this.jsonParser = new JSONParser();
    }

    public class hapusMedisOrtu extends AsyncTask<String, Void, String> {
        ProgressDialog dialog;
        String url_hapus_medis;

        public hapusMedisOrtu() {
            this.url_hapus_medis = "http://rekammedis.gudangtechno.web.id/android/hapus_rekammedis.php?id_periksa=" + PetugasDetailRekamMedisOrtu2Activity.this.isi_periksa;
        }

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PetugasDetailRekamMedisOrtu2Activity.this);
        ...
        protected String doInBackground(String... arg0) {
            JSONObject json = PetugasDetailRekamMedisOrtu2Activity.this.jsonParser.getJSONFromUrl(url_hapus_medis);
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            dialog.dismiss();
            if (success == 1) {
                Intent medis = new Intent(PetugasDetailRekamMedisOrtu2Activity.this, PetugasMenuPriaActivity.class);
                startActivity(medis);
                PetugasDetailRekamMedisOrtu2Activity.this.finish();
            } else {
                Toast.makeText(PetugasDetailRekamMedisOrtu2Activity.this.getApplicationContext(), "Mohon Periksa Koneksi Internet Anda...", Toast.LENGTH_SHORT).show();
            }
        }
    }
