...
public class PetugasListRekamMedisOrangtuaActivity extends AppCompatActivity {
    Button tambah_medis;
    ...
    public PetugasListRekamMedisOrangtuaActivity(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_rekammedis.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int urutan, long id) {
                ...
                Intent i = null;
                i = new Intent(PetugasListRekamMedisOrangtuaActivity.this, PetugasDetailRekamMedisOrtuActivity.class);
                Bundle b = new Bundle();
        ...
        this.tambah_medis.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i = new Intent(PetugasListRekamMedisOrangtuaActivity.this, PetugasTambahRekamMedisOrangtuaActivity.class);
                Bundle b = new Bundle();
    ...
    class ReadRekamMedisTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(PetugasListRekamMedisOrangtuaActivity.this);
        ...
        protected String doInBackground(String... sText) {
            url_tampil_medis= "http://rekammedis.gudangtechno.web.id/android/tampil_medis.php?no_ktp="+PetugasListRekamMedisOrangtuaActivity.this.strktp;
            RekamMedis tempMedis = new RekamMedis();
            try {
                JSONObject json = PetugasListRekamMedisOrangtuaActivity.this.jsonParser.getJSONFromUrl(url_tampil_medis);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(PetugasListRekamMedisOrangtuaActivity.this, "Periksa Koneksi Internet Anda...", Toast.LENGTH_LONG).show();
            }
            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(PetugasListRekamMedisOrangtuaActivity.this, "Data Rekam Medis Masih Kosong", Toast.LENGTH_LONG).show();
            }
            if(success == 1) {
                list_rekammedis.setAdapter(new RekamMedisAdapter(PetugasListRekamMedisOrangtuaActivity.this, PetugasListRekamMedisOrangtuaActivity.this.daftar_rekammedis));
            }
        }
    }
    @Override
