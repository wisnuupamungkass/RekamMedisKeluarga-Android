...
public class PetugasTambahRekamMedisOrangtuaActivity extends AppCompatActivity {
    ...
    class tambah_rekam implements View.OnClickListener {
        public void onClick(View v) {
            PetugasTambahRekamMedisOrangtuaActivity.this.validation();
        }
    }
    ...
    public void setDateTimeField() {
        this.tanggal_pemeriksaan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                PetugasTambahRekamMedisOrangtuaActivity.this.tanggal_dialog.show();
            }
        });
        ...
        this.tanggal_dialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                PetugasTambahRekamMedisOrangtuaActivity.this.tanggal_pemeriksaan.setText(PetugasTambahRekamMedisOrangtuaActivity.this.dateFormatter.format(newDate.getTime()));
            }
    ...
    public class tambahMedisOrtu extends AsyncTask<String, String, String> {
        ...
        public tambahMedisOrtu() {
            this.strtanggal = PetugasTambahRekamMedisOrangtuaActivity.this.tanggal_pemeriksaan.getText().toString();
            this.strkeluhan = PetugasTambahRekamMedisOrangtuaActivity.this.keluhan.getText().toString();
            this.strriwayat = PetugasTambahRekamMedisOrangtuaActivity.this.riwayat_penyakit.getText().toString();
            this.strdiagnosa = PetugasTambahRekamMedisOrangtuaActivity.this.diagnosa.getText().toString();
            this.strmedis = PetugasTambahRekamMedisOrangtuaActivity.this.tindakan_medis.getText().toString();
            this.strobat = PetugasTambahRekamMedisOrangtuaActivity.this.obat.getText().toString();
        }
        protected void onPreExecute() {
            super.onPreExecute();
            PetugasTambahRekamMedisOrangtuaActivity.this.pDialog = new ProgressDialog(PetugasTambahRekamMedisOrangtuaActivity.this);
            PetugasTambahRekamMedisOrangtuaActivity.this.pDialog.setMessage("Loading...");
            PetugasTambahRekamMedisOrangtuaActivity.this.pDialog.setIndeterminate(false);
            PetugasTambahRekamMedisOrangtuaActivity.this.pDialog.show();
        }
        ...
        public String getPertumbuhanList() {
            ...
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_TANGGAL, this.strtanggal));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_KELUHAN, this.strkeluhan));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_RIWAYAT, this.strriwayat));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_DIAGNOSA, this.strdiagnosa));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_TINDAKAN, this.strmedis));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_OBAT, this.strobat));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_KTP, strktp));
            params.add(new BasicNameValuePair(PetugasTambahRekamMedisOrangtuaActivity.TAG_PETUGAS, strpetugas));
        ...
        protected void onPostExecute(String result) {
            ...
            PetugasTambahRekamMedisOrangtuaActivity.this.pDialog.dismiss();

            if (result.equalsIgnoreCase("Error Converting")){
                Toast.makeText(PetugasTambahRekamMedisOrangtuaActivity.this, "Periksa Koneksi Internet Anda...",  Toast.LENGTH_SHORT).show();
            }
            else if (result.equalsIgnoreCase("Exception Caught")){
                Toast.makeText(PetugasTambahRekamMedisOrangtuaActivity.this, "Periksa Koneksi Internet Anda...",  Toast.LENGTH_SHORT).show();
            }
            else if (success == 1){
                AlertDialog.Builder pDialog = new AlertDialog.Builder(PetugasTambahRekamMedisOrangtuaActivity.this);
                ...
                Toast.makeText(PetugasTambahRekamMedisOrangtuaActivity.this.getApplicationContext(), "Gagal Tambah Data Rekam Medis...", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected class berhasil implements DialogInterface.OnClickListener {
            public void onClick(DialogInterface dialog, int d) {
                dialog.dismiss();
                Intent medis = new Intent(PetugasTambahRekamMedisOrangtuaActivity.this, PetugasMenuPerempuanActivity.class);
                startActivity(medis);
                PetugasTambahRekamMedisOrangtuaActivity.this.finish();
            }
        }
    }
