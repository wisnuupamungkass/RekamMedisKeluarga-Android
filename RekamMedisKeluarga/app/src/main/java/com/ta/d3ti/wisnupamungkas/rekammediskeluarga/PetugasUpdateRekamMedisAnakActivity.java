...
public class PetugasUpdateRekamMedisAnakActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_petugas_update_rekam_medis_anak);
    ...
    class update_rekam implements View.OnClickListener {
        public void onClick(View v) {
            PetugasUpdateRekamMedisAnakActivity.this.validation();
        }
    }
    ...
    public void setDateTimeField() {
        this.tanggal_pemeriksaan.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                PetugasUpdateRekamMedisAnakActivity.this.tanggal_dialog.show();
            }
        });
        ...
        this.tanggal_dialog = new DatePickerDialog(this, new DatePickerDialog.OnDateSetListener() {
            public void onDateSet(DatePicker view, int year, int monthOfYear, int dayOfMonth) {
                ...
                PetugasUpdateRekamMedisAnakActivity.this.tanggal_pemeriksaan.setText(PetugasUpdateRekamMedisAnakActivity.this.dateFormatter.format(newDate.getTime()));
            }
    ...
    public void validation() {
        ...
        new updateMedisAnak().execute();
    }
    public class updateMedisAnak extends AsyncTask<String, String, String> {
        String strtanggal;
        String strkeluhan;
        String strriwayat;
        String strdiagnosa;
        ...
        public updateMedisAnak() {
            this.strtanggal = PetugasUpdateRekamMedisAnakActivity.this.tanggal_pemeriksaan.getText().toString();
            this.strkeluhan = PetugasUpdateRekamMedisAnakActivity.this.keluhan.getText().toString();
            this.strriwayat = PetugasUpdateRekamMedisAnakActivity.this.riwayat_penyakit.getText().toString();
            this.strdiagnosa = PetugasUpdateRekamMedisAnakActivity.this.diagnosa.getText().toString();
            this.strmedis = PetugasUpdateRekamMedisAnakActivity.this.tindakan_medis.getText().toString();
            this.strobat = PetugasUpdateRekamMedisAnakActivity.this.obat.getText().toString();
        }

        protected void onPreExecute() {
            super.onPreExecute();
            PetugasUpdateRekamMedisAnakActivity.this.pDialog = new ProgressDialog(PetugasUpdateRekamMedisAnakActivity.this);
            PetugasUpdateRekamMedisAnakActivity.this.pDialog.setMessage("Loading...");
            PetugasUpdateRekamMedisAnakActivity.this.pDialog.setIndeterminate(false);
            PetugasUpdateRekamMedisAnakActivity.this.pDialog.show();
        }
        ...
        public String getPertumbuhanList() {
            ...
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_ID_REKAM, stridrekam));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_TANGGAL, this.strtanggal));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_KELUHAN, this.strkeluhan));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_RIWAYAT, this.strriwayat));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_DIAGNOSA, this.strdiagnosa));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_TINDAKAN, this.strmedis));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_OBAT, this.strobat));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_REGISTER, strregister));
            params.add(new BasicNameValuePair(PetugasUpdateRekamMedisAnakActivity.TAG_PETUGAS, strpetugas));
        ...
        protected void onPostExecute(String result) {
            ...
            PetugasUpdateRekamMedisAnakActivity.this.pDialog.dismiss();

            if (result.equalsIgnoreCase("Error Converting")){
                Toast.makeText(PetugasUpdateRekamMedisAnakActivity.this, "Periksa Koneksi Internet Anda...",  Toast.LENGTH_SHORT).show();
            }
            else if (result.equalsIgnoreCase("Exception Caught")){
                Toast.makeText(PetugasUpdateRekamMedisAnakActivity.this, "Periksa Koneksi Internet Anda...",  Toast.LENGTH_SHORT).show();
            }
            else if (success == 1){
                AlertDialog.Builder pDialog = new AlertDialog.Builder(PetugasUpdateRekamMedisAnakActivity.this);
                pDialog.setTitle("Update Rekam Medis");
                pDialog.setMessage("Data Rekam Medis Berhasil Terupdate");
                pDialog.setNeutralButton("OK", new berhasil()).show();
            }
            else if (success == 0) {
                Toast.makeText(PetugasUpdateRekamMedisAnakActivity.this.getApplicationContext(), "Gagal Update Data Rekam Medis...", Toast.LENGTH_SHORT).show();
            }
        }
        ...
        protected class berhasil implements DialogInterface.OnClickListener {
            public void onClick(DialogInterface dialog, int d) {
                dialog.dismiss();
                Intent medis = new Intent(PetugasUpdateRekamMedisAnakActivity.this, PetugasMenuAnakActivity.class);
                startActivity(medis);
                PetugasUpdateRekamMedisAnakActivity.this.finish();
            }
        }
    }
