...
public class PetugasDetailRekamMedisOrtuActivity extends AppCompatActivity {
    ...
    class edit_medis implements View.OnClickListener{
        public void onClick(View v) {
            ...
            Intent i = new Intent(PetugasDetailRekamMedisOrtuActivity.this, PetugasUpdateRekamMedisOrtuActivity.class);
            Bundle b = new Bundle();
    ...
    class hapus_medis implements View.OnClickListener{
        public void onClick(View v){
            AlertDialog.Builder builder = new AlertDialog.Builder(PetugasDetailRekamMedisOrtuActivity.this);
    ...
    public PetugasDetailRekamMedisOrtuActivity() {
    ...
    public class hapusMedisOrtu extends AsyncTask<String, Void, String> {
        ...
        public hapusMedisOrtu() {
            this.url_hapus_medis = "http://rekammedis.gudangtechno.web.id/android/hapus_rekammedis.php?id_periksa=" + PetugasDetailRekamMedisOrtuActivity.this.isi_periksa;
        }

        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            dialog = new ProgressDialog(PetugasDetailRekamMedisOrtuActivity.this);
        ...
        protected String doInBackground(String... arg0) {
            JSONObject json = PetugasDetailRekamMedisOrtuActivity.this.jsonParser.getJSONFromUrl(url_hapus_medis);
            try {
        ...
        protected void onPostExecute(String result) {
            ...
            dialog.dismiss();
            if (success == 1) {
                Intent medis = new Intent(PetugasDetailRekamMedisOrtuActivity.this, PetugasMenuPerempuanActivity.class);
                startActivity(medis);
                PetugasDetailRekamMedisOrtuActivity.this.finish();
            } else {
                Toast.makeText(PetugasDetailRekamMedisOrtuActivity.this.getApplicationContext(), "Mohon Periksa Koneksi Internet Anda...", Toast.LENGTH_SHORT).show();
            }
        }
    }
