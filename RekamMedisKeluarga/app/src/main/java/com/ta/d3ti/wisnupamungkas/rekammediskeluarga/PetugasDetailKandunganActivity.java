...
public class PetugasDetailKandunganActivity extends AppCompatActivity {
    Button tambah_detail_kandungan;
    Button lihat_usg;
    ...
    public PetugasDetailKandunganActivity() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_petugas_detail_kandungan);
        this.tambah_detail_kandungan = (Button) findViewById(R.id.button_tambah_detail_kandungan);
        ...
        list_detail_kandungan.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int urutan, long id) {
                ...
                Intent i = new Intent(PetugasDetailKandunganActivity.this, PetugasLihatDetailKandunganActivity.class);
                Bundle b = new Bundle();
        ...
        tambah_detail_kandungan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent kandungan = new Intent(PetugasDetailKandunganActivity.this, PetugasTambahDetailKandunganActivity.class);
                Bundle b = new Bundle();
                b.putString("kandungan_id", stridkandungan);
                b.putString("petugas_id", strpetugas);
        ...
        lihat_usg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent kandungan = new Intent(PetugasDetailKandunganActivity.this, PetugasLihatUsgActivity.class);
                Bundle b = new Bundle();
                b.putString("kandungan_id", stridkandungan);
                b.putString("petugas_id", strpetugas);
                kandungan.putExtras(b);
    ...
    class ReadDetailKandunganTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(PetugasDetailKandunganActivity.this);
        ...
        protected String doInBackground(String... sText) {
            url_tampil_detail_kandungan = "http://rekammedis.gudangtechno.web.id/android/tampil_detail_kandungan.php?kandungan_id="+PetugasDetailKandunganActivity.this.stridkandungan;

            DetailKandungan tempDetailKandungan = new DetailKandungan();
            try {
                JSONObject json = PetugasDetailKandunganActivity.this.jsonParser.getJSONFromUrl(url_tampil_detail_kandungan);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(PetugasDetailKandunganActivity.this, "Mohon Periksa Koneksi Internet Anda...", Toast.LENGTH_LONG).show();
            }
            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(PetugasDetailKandunganActivity.this, "Data Kandungan Masih Kosong", Toast.LENGTH_LONG).show();
            }
            if (success == 1) {
                list_detail_kandungan.setAdapter(new DetailKandunganAdapter(PetugasDetailKandunganActivity.this, PetugasDetailKandunganActivity.this.daftar_detail_kandungan));
            }
        }
    }
    @Override
