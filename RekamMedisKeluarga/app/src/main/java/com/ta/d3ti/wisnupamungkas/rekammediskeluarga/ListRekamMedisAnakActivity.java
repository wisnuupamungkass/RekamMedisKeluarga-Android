...
public class ListRekamMedisAnakActivity extends AppCompatActivity{
    ...
    public ListRekamMedisAnakActivity(){
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_rekammedis.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int urutan, long id) {
                ...
                Intent i = null;
                i = new Intent(ListRekamMedisAnakActivity.this, DetailRekamMedisActivity.class);
                Bundle b = new Bundle();
    ...
    class ReadRekamMedisTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(ListRekamMedisAnakActivity.this);
        ...
        protected String doInBackground(String... sText) {
            url_tampil_medis= "http://rekammedis.gudangtechno.web.id/android/tampil_medis_anak.php?no_register="+ListRekamMedisAnakActivity.this.strregister;
            RekamMedis tempMedis = new RekamMedis();
            try {
                JSONObject json = ListRekamMedisAnakActivity.this.jsonParser.getJSONFromUrl(url_tampil_medis);
        ...
        protected void onPostExecute(String result) {
            ...
            if (result.equalsIgnoreCase("Exception Caught")) {
                Toast.makeText(ListRekamMedisAnakActivity.this, "Periksa Koneksi Internet Anda...", Toast.LENGTH_LONG).show();
            }
            if (result.equalsIgnoreCase("no results")) {
                Toast.makeText(ListRekamMedisAnakActivity.this, "Data Rekam Medis Masih Kosong", Toast.LENGTH_LONG).show();
            }
            if(success == 1) {
                list_rekammedis.setAdapter(new RekamMedisAdapter(ListRekamMedisAnakActivity.this, ListRekamMedisAnakActivity.this.daftar_rekammedis));
            }
        }
    }
    @Override
